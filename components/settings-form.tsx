        ...
        <CardContent>
          <Tabs defaultValue="personal">
            ...
            <TabsContent value="billing" className="space-y-4">
              ...
              <div className="space-y-2">
                <Label>Frequenza di Fatturazione</Label>
                <RadioGroup
                ...
                >
                  <div className="flex items-center space-x-2">
                    ...
                    <Label htmlFor="monthly">Mensile (fatturazione il 1° di ogni mese)</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="quarterly" id="quarterly" />
                    <Label htmlFor="quarterly">Trimestrale (fatturazione il 1° gennaio, 1° aprile, 1° luglio, 1° ottobre)</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="yearly" id="yearly" />
                    <Label htmlFor="yearly">Annuale (fatturazione il 1° gennaio)</Label>
                  </div>
                </RadioGroup>
              </div>
            </TabsContent>
